...
const Contacts = () => {
  ...
  useEffect(() => {
    axios.get('https://filprtaskbackend-5.onrender.com/api/projects-users/users')
      .then(response => {
  ...
  const handleApprove = (userId, isApprove) => {
    axios.put(`https://filprtaskbackend-5.onrender.com/api/projects-users/update/${userId}`, {
      isApprove: !isApprove
    })
      .then(response => {
